...
//переменные обьявленные через лет можно переопределять
...
console.log('5'); //в консоле браузера тип данных будет отличаться цветом в данном примере обычный цвет
