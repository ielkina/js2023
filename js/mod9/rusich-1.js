...
// const date = new Date();//возвращает обьект времени
// const date = Date.now();//возвращает число в милесекундах Unix времени начиная с 01,01,1970 года
