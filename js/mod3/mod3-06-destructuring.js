//[P]Деструктуризация объекта - распаковка
...
const { } = playlist;
const { trackCount: numberOFTracks1 = 0 } = playlist;
...
console.log(numberOFTracks1);

//в объекты свойства не пишет а читает
console.log(playlist);

//[P]Глубокая Деструктуризация
...
const {
  ...
  location1,
  avatar1,
  stats: { likes1, followers1, views1 }, //глубокая Деструктуризация
} = profile;
//глубокая Деструктуризация
console.log(name2, tag1, location1, avatar1, followers1, views1, likes1);
...
// или
// rest всегда в конце
const { name3, tag2, location2, ...restProps} = profile;

console.log(name3, tag2, location2);
console.log(restProps);
console.log(profile);

//[P]Паттерн "Объект настроек"
